...
void TestMachine()
{
   ...
   bfi->commands.push_back(new CommandIncCell{1});
   bfi->commands.push_back(new CommandIncPtr{1});
   bfi->commands.push_back(new CommandIncCell{2});
   bfi->commands.push_back(new CommandIncPtr{1});
   bfi->commands.push_back(new CommandIncCell{3});
